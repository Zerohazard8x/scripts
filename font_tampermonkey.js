...
const runes = "Material Icons Extended, Material Icons, Google Material Icons, Material Design Icons, rtings-icons, VideoJS";
...
["body", "h1", "h2", "p"].forEach(tag => {
  ...
  for (let i = 0; i < elems.length; i++) {
    ...
    if (fontRegex.test(font)) {
      ...
      elems[i].style.fontFamily = `${matchedFont}, ${runes}`; // replace with matched font
    }
  }
});
