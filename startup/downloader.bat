...
if exist "%downloadDir%\startup_tasks.bat" del /q /f "%downloadDir%\startup_tasks.bat"
...
if exist "%downloadDir%\common.bat" (
    ...
    if not errorlevel 1 (
        ...
        call :Status "downloading startup_tasks.bat"
        ...
        if not errorlevel 1 (
            call :Status "running startup_tasks.bat"
...
del /q /f "%downloadDir%\startup_tasks.bat" 2>nul
