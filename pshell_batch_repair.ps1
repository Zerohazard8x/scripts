...
powershell.exe -c choco upgrade chocolatey ffmpeg mpv aria2 rsync git python3 nomacs kate okular audacity deluge audacious smplayer -y
powershell.exe -c choco install ffmpeg mpv aria2 rsync git python3 nomacs kate okular audacity deluge audacious smplayer -y
