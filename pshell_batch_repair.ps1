...
# choco upgrade picard audacity kdenlive retroarch kodi pdfsam obs-studio foobar2000 parsec darktable chromium qemu fontforge doomsday ioquake3 steam meld czkawka libreoffice virtualbox smplayer unetbootin qbittorrent -y
