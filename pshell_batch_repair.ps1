...
if (Get-Command choco -ErrorAction SilentlyContinue) { 
    ...
    # choco upgrade alacritty blender chromium czkawka darktable doomsday ioquake3 jdownloader kdenlive meld microsoft-edge neovim opera parsec pdfsam retroarch tor-browser wezterm
