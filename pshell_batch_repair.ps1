...
choco upgrade chocolatey ffmpeg mpv aria2 rsync git python3 nomacs deluge vlc chromium doublecmd filezilla 7zip smplayer adb dos2unix openvpn -y
# choco upgrade picard audacity kdenlive okular retroarch kodi pdfsam obs-studio atom foobar2000 makemkv parsec darktable -y
