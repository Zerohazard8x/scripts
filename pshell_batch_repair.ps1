...
powershell.exe -c choco upgrade chocolatey ffmpeg mpv aria2 rsync git python3 nomacs atom okular audacity deluge audacious smplayer chromium doublecmd obs-studio filezilla kdenlive openvpn picard 7zip parsec adb -y
powershell.exe -c choco install ffmpeg mpv aria2 rsync git python3 nomacs atom okular audacity deluge audacious smplayer chromium doublecmd obs-studio filezilla kdenlive openvpn picard parsec 7zip adb -y
