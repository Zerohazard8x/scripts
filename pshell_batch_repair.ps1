...
choco upgrade chocolatey 7zip adb aria2 dos2unix ffmpeg filezilla firefox git jq mpv nomacs okular openvpn powershell rsync scrcpy smplayer tor-browser unison vlc -y
# choco upgrade audacity blender chromium discord foobar2000 jellyfin libreoffice microsoft-edge pdfsam picard steam thunderbird vscode -y
# choco upgrade czkawka darktable doomsday ioquake3 jdownloader kdenlive kodi meld obs-studio parsec qbittorrent retroarch
