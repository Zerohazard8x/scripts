...
powershell.exe -c choco upgrade chocolatey ffmpeg mpv vlc aria2 rsync git python3 nomacs atom okular audacity deluge audacious chromium doublecmd obs-studio filezilla kdenlive openvpn picard 7zip parsec adb retroarch kodi pdfsam -y
powershell.exe -c choco install ffmpeg mpv vlc aria2 rsync git python3 nomacs atom okular audacity deluge audacious chromium doublecmd obs-studio filezilla kdenlive openvpn picard parsec 7zip adb retroarch kodi pdfsam -y
