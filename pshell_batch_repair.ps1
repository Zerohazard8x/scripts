...
choco upgrade chocolatey ffmpeg mpv aria2 rsync git nomacs deluge vlc firefox unison filezilla 7zip zstd dos2unix openvpn okular adb scrcpy youtube-dl -y
