...
powershell.exe -c choco upgrade chocolatey ffmpeg mpv aria2 rsync git python3 nomacs atom okular audacity deluge audacious smplayer chromium doublecmd obs-studio filezilla kdenlive openvpn -y
powershell.exe -c choco install ffmpeg mpv aria2 rsync git python3 nomacs atom okular audacity deluge audacious smplayer chromium doublecmd obs-studio filezilla kdenlive openvpn -y
